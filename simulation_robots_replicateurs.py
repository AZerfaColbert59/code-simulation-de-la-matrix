...
def type_suite(nb_planete: int, nb_robot: int) -> str:
    ...
    for nb_tour2 in range(1, 11):
        current_sum = sum(robots_planete(nb_planete, nb_robot, nb_tour2))
        prev_sum = sum(robots_planete(nb_planete, nb_robot, nb_tour2-1))
        prev_prev_sum = sum(robots_planete(nb_planete, nb_robot, nb_tour2-2))
